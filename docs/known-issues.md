...
- The caller remains responsible for stable addressed-RNG sample-index assignment. Phase 0.4 scheduler order does not allocate biological samples or define future contention fairness.
...
- No biological runtime or save format exists in Phase 0.4.
